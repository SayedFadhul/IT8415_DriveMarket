...
$comments_total_pages = ceil($comments_total / $limit);

$comments_sql = "SELECT c.comment_text, c.created_at, car.title
...
$ratings_total_pages = ceil($ratings_total / $limit);

$ratings_sql = "SELECT r.rating_value, r.created_at, car.title
...
$offers_total_pages = ceil($offers_total / $limit);

$offers_sql = "SELECT o.offer_amount, o.message, o.created_at, car.title
...
$appointments_total_pages = ceil($appointments_total / $limit);

$appointments_sql = "SELECT a.appointment_date, a.appointment_time, a.notes, a.created_at, car.title
